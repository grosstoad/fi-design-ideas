> **SUPERSEDED FOR STYLE (owner decision 2026-07-10, FILL-IN #32):** the canonical Fundora illustration style is **casual-client's candy-cartoon sticker system** (`casual-client/assets/`: bold true-black vector outlines, flat high-chroma fills led by hot pink `#F5327F` and marigold `#FBB515`, no ground shadows, transparent backgrounds — full characterisation in the 2026-07-10 independent style review, prompts in `landing-b-iteration-plan.md` §8). The muted inked-risograph craft described in §1–§3 below is **deprecated**; existing Paper input-flow assets stay until regenerated in the standard. Still current: the tier/scale system (§2), motion language (§4 — note the line-boil move assumed hand-inked lines and needs re-judging against clean vector outlines; sticker-place/press/success translate directly), character scoping (§5a — and casual-client's `fundora.png` avatar, glasses and all, IS the canonical character asset), placement rules (§6) and the award checklist (§7).
